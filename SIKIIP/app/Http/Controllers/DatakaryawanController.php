...
class DatakaryawanController extends Controller
{
    ...
    public function index() {
        ...
        $password   = \App\DefaultPengaturan::where('nama_default','password')->first();

        return view('Datakaryawan.Datakaryawan', ['data_karyawan' => $data_karyawan, 'riwayat_pendidikan' => $riwayat_pendidikan, 'divisi' => $divisi , 'password' => $password]);
    }
    ...
    public function edit_data_pribadi($nik){
        $data_karyawan = \App\Datakaryawan::where('nik',$nik)->first();
        $divisi     = \App\Divisi::all();
        return view('Datakaryawan.datakaryawan_edit_data_pribadi', ['data_karyawan' => $data_karyawan , 'divisi' => $divisi]);
    }
    ...
    public function pengaturan_data_karyawan()
    {
        $password   = \App\DefaultPengaturan::where('nama_default','password')->first();

        return view('Datakaryawan.pengaturan_data_karyawan',['password' => $password]);

    }

    public function pengaturan_password(Request $request){

            //Update data
        $data = \App\DefaultPengaturan::where('nama_default','password');
