    ...
    <div class="be-content">
      ...
      <div class="main-content container-fluid">
        <div class="row">
                  ...
                  <div class="table-responsive noSwipe">
                    <table class="table table-striped table-hover">
                     <thead>
                      <tr>
                        ...
                        <th style="width:20%">Tanggal Masuk Kerja</th>
                        <th style="width:20%">Tanggal Selesai Kerja</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{$data->tanggal_selesai_kerja}}</td>
          ...
          <!-- Modals untuk Edit Tambah Data Riwayat Pekerjaan -->
           ...
           <div id="tambah-data-familia" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="form-group">
                  <label>Tanggal Selesai Kerja (Di Kantor Sebelumnya)</label>
                  <input name="tanggal_selesai_kerja" type="date" class="form-control" required="" >
                </div>
                <div class="form-group">
                  <label>Gaji Akhir</label>
