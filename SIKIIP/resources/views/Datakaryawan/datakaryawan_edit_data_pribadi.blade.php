                      ...
                      <div class="panel-heading">Data Pribadi
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              <label>NIK</label>
                              <input name="nik" type="number" value="{{$data_karyawan->nik}}" placeholder="1234567098765432" class="form-control">
                            </div>
                            <div class="form-group">
                              <label>Nama</label>
                              <input name="nama_karyawan" type="text" value="{{$data_karyawan->nama_karyawan}}" placeholder="Adinda Virguinia Ayu Permata Manihuruk" class="form-control">
                            </div>
                              <div class="form-group">
                              <label>Jabatan/Divisi</label>
                              <input name="divisi" type="text" value="{{$data_karyawan->divisi}}" placeholder="Tech Development" class="form-control">
                            </div>
                            <div class="form-group">
