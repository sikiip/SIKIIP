                ...
                <div class="panel-body">
                 ...
                 <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" value="{{$data_karyawan->masa_kerja}}" class="form-control" readonly="">              
                            </div>
                            <div class="form-group">
                                  ...
                                  @if($data_karyawan->nik == $familia['nik'])
                                      @if($familia->jenis_hubungan == 'Istri' )
                                            <div class="form-group">
                                              ...
                                              <input type="text" value="{{$familia->nama_familia}}" class="form-control" readonly="">              
                                            </div>
                                            <div class="form-group">
                                              <label>Tempat Lahir</label>
                                              <input type="text" value="{{$familia->tempat_lahir_familia}}" class="form-control" readonly="">
                                            </div>
                                            <div class="row">
                                              <div class="form-group col-md-12">
                                                <label>Tanggal Lahir</label>
                                            ...
                                            <div class="row no-margin-y">
                                              <div class="form-group col-xs-3">
                                                <input type="text" value="{{DateTime::createFromFormat('Y-m-d',$familia->tanggal_lahir_familia)->format('d')}}" class="form-control" readonly="">
                                                </div>
                                                <div class="form-group col-xs-3">
                                                  <input type="text" value="{{DateTime::createFromFormat('Y-m-d',$familia->tanggal_lahir_familia)->format('M')}}" class="form-control" readonly="">
                                                </div>
                                                <div class="form-group col-xs-3">
                                                  <input type="text" value="{{DateTime::createFromFormat('Y-m-d',$familia->tanggal_lahir_familia)->format('Y')}}" class="form-control" readonly="">
                                                </div>
                                            </div>
                                      ...
                                      @elseif($familia->jenis_hubungan == 'Anak')
                                             <div class="form-group">
                                              ...
                                              <input type="text" value="{{$familia->nama_familia}}" class="form-control" value="" readonly="">
                                            </div>
                                            <div class="form-group">
                                              <label>Jenis Kelamin Anak ke-{{$i}}</label>
                                              <input type="text" value="{{$familia->jenis_kelamin_familia}}" class="form-control" readonly="">
                                            </div>
                                            <div class="form-group">
