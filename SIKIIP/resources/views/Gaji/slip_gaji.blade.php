<body style="background-color: white;">
  ...
  .profil2{
    margin: -43px 0px 0px 123px;
    
  }

  .circular--portrait button:hover{
    /*border-radius:27px;*/
    color:white;
  ...
  *,
  ...
  @media (min-width:768px) {
    ...
    .be-left-sidebar .sidebar-elements>li.divider>span {
      color: #000;
      font-size: 16px;
    }
  }
  ...
  .be-left-sidebar .sidebar-elements>li ul li.parent>a,
  .be-left-sidebar .sidebar-elements>li.parent>a>span {
    color: #000;
    font-size: 15px;
  }
...
.be-sub-navigation .navbar-nav>li.open>a,
.be-sub-navigation .navbar-nav>li.open>a:focus {
  color: #333
}
...
.be-sub-navigation .navbar-nav>li.dropdown .dropdown-menu:after,
...
$kmplnBln=" Januari Februari Maret April Mei Juni Juli Augustus September October November December";
$arrayBln=explode(" ", $kmplnBln);

$tgl   = date("d");
$bulan = date("m");
$tahun = date("Y");
$blnn = $arrayBln[$bln];
$tanggal = $tgl.' '.$blnn.' '.$tahun;

@endphp
<div style="width: 703px;background-color: white;" class="user-info-list panel panel-default">
    ...
    <table class="no-border no-strip skills">
      <tbody class="no-border-x no-border-y">
        <tr>
          ...
          <td></td>
          <td>
            <div style="margin-left: 60px; font-family: 'poppins'; "><h5><b>PT. IDEA IMAJI PERSADA</b></h5></div>
          </td>
        </tr>
      </tbody>
    </table >
  ...
  <div class="panel-body">
    ...
    <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
      <tbody>
        ...
        <tr>
          <td>Gaji Pokok</td>
          <td>Rp{{number_format($data_gaji_blade['gaji_pokok'],2,",",".")}}</td>            
        </tr>
        <!--  Row Pengalaman Bulan End -->
        <!--  Row Gaji Pokok Start -->
        <tr>
          <td>Tunjangan Profesi</td>
          <td>Rp{{number_format($data_gaji_blade['T_profesi'],2,",",".")}}</td>            
        </tr>
        <!--  Row Gaji Pokok End -->
        <!--  Row Tunjangan Profesi Start -->
        <tr>
          <td>Tunjangan Jabatan</td>
          <td>Rp{{number_format($data_gaji_blade['T_jabatan'],2,",",".")}}</td>            
        </tr>
        <!--  Row Tunjangan Profesi End -->
        <!--  Row Tunjangan Jabatan Start -->
        <tr>
          <td >Tunjangan Kinerja</td>
          <td>Rp{{number_format($data_gaji_blade['T_kinerja'],2,",",".")}}</td>            
        </tr>
        <!--  Row Tunjangan Jabatan End -->
        <!--  Row Tunjangan Kinerja Start -->
        <tr>
          <td >Tunjangan Khusus</td>
          <td>Rp{{number_format($data_gaji_blade['T_khusus'],2,",",".")}}</td>            
        </tr>
        <!--  Row Tunjangan Kinerja End -->
        <!--  Row Tunjangan Kinerja Start -->
        <tr>
          <td >Tunjangan Transportasi</td>
          <td>Rp{{number_format($data_gaji_blade['T_transport'],2,",",".")}}</td>            
        </tr>
        <!--  Row Tunjangan Kinerja End -->
        <!--  Row Tunjangan Kinerja Start -->
        <tr>
          <td >Insentif</td>
          <td>Rp{{number_format($data_gaji_blade['insentif'],2,",",".")}}</td>  
        </tr>
        <!--  Row Tunjangan Kinerja End -->
        <!--  Row Tunjangan Kinerja Start -->
        <tr>
          <td >Asuransi (BPJS)</td>
          <td>Rp{{number_format($data_gaji_blade['bpjs_kesehatan_perusahaan'] + $data_gaji_blade['bpjs_ketenagakerjaan_JKK'] + $data_gaji_blade['bpjs_ketenagakerjaan_JKM'],2,",",".")}}</td>
        </tr>
        <!--  Row Tunjangan Kinerja End -->
        <!--  Row Tunjangan Kinerja Start -->
        <tr>
          <td >Total Pendapatan</td>
          <td>Rp{{number_format($data_gaji_blade['total_gaji'],2,",",".")}}</td>
        </tr>
        <!--  Row Tunjangan Kinerja End -->
      </tbody>
    </table>
    ...
    <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
      <tbody>
       ...
       <tr>
        <td>PPH21</td>
        <td>Rp{{number_format($data_gaji_blade['pph_21'],2,",",".")}}</td>            
      </tr>
      <!--  Row Pengalaman Bulan End -->
      <!--  Row Gaji Pokok Start -->
      <tr>
        <td>Disisentif</td>
        <td>Rp{{number_format($data_gaji_blade['disinsentif'],2,",",".")}}</td>            
      </tr>
      <!--  Row Gaji Pokok End -->
      <!--  Row Tunjangan Profesi Start -->
      <tr>
        <td>BPJS (Kesehatan dan Ketenagakerjaan)</td>
        <td>Rp{{number_format($data_gaji_blade['potongan_BPJS'],2,",",".")}}</td>            
      </tr>
      <!--  Row Tunjangan Profesi End -->
      <!--  Row Tunjangan Jabatan Start -->
      <tr>
        <td >Lain-lain</td>
        <td>Rp{{number_format($data_gaji_blade['potongan'],2,",",".")}}</td>            
      </tr>
      <!--  Row Tunjangan Jabatan End -->
      <!--  Row Tunjangan Kinerja Start -->
      <tr>
        <td >Total Potongan</td>
        <td>Rp{{number_format($data_gaji_blade['total_potongan'],2,",",".")}}</td>            
      </tr>
      <!--  Row Tunjangan Kinerja End -->
    </tbody>
  </table>
  ...
  <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
    <tbody>
     <!--  Row Pengalaman Bulan Start -->
     <tr>
      <td>Total (Pendapatan - Potongan)</td>
      <td>Rp{{number_format($data_gaji_blade['dibayar'],2,",",".")}}</td>
    </tr>
    <!--  Row Pengalaman Bulan End -->
  </tbody>
</table>
<table>
  <tbody>
    <tr>
      <td>
        <Div align= "center">
          Bandung, <time id="time">{{$tanggal}}</time>
        </Div>
        <br>
        <br>
        <br>
