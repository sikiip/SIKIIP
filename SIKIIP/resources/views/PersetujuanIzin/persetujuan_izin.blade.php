...
<!--   Content End  -->
<!-- modal Izinkan Start -->
<div id="izinkan" tabindex="-1" role="dialog" class="modal fade">
          ...
          <div class="modal-body">
            <div class="text-center">
              ...
              <div class="xs-mt-50">
                ...
                <button type="button"  data-target="tolak-ya" data-dismiss="modal" class="btn btn-space btn-primary">Ya</button>
              </div>
            </div>
          </div>
...
<!-- Modal Tolak Start -->
<div id="tolak" tabindex="-1" role="dialog" class="modal fade">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" data-dismiss="modal" aria-hidden="true" class="close"><span class="mdi mdi-close"></span></button>
