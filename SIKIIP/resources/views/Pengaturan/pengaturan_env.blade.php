...
<body>
  ...
  <div class="be-wrapper">
    ...
    <div class="be-content be-icons-list">
      <div class="page-head">
       <h2 class="page-head-title">Pengaturan ENV</h2>
     </div>
     <div class="main-content container-fluid">

       <!--  Edit Default Start -->
       <div class="panel">
        <div class="panel-heading panel-heading-divider"><b>Pengaturan ENV</b><span class="panel-subtitle">Edit Pengaturan ENV</span></div>
        <div class="panel-body">
          <form action="/pengaturan_env/update" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
            @csrf
            <div class="form-group">
              <label class="col-sm-3 control-label">DB_CONNECTION</label>
              <div class="col-sm-6">
                <input name="DB_CONNECTION" type="text" value="{{env('DB_CONNECTION_SECOND')}}" class="form-control">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">DB_HOST</label>
              <div class="col-sm-6">
                <input name="DB_HOST" type="text" value="{{env('DB_HOST_SECOND')}}" class="form-control">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">DB_PORT</label>
              <div class="col-sm-6">
                <input name="DB_PORT" type="text" value="{{env('DB_PORT_SECOND')}}" class="form-control">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">DB_DATABASE</label>
              <div class="col-sm-6">
                <input name="DB_DATABASE" type="text" value="{{env('DB_DATABASE_SECOND')}}" class="form-control">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">DB_USERNAME</label>
              <div class="col-sm-6">
                <input name="DB_USERNAME" type="text" value="{{env('DB_USERNAME_SECOND')}}" class="form-control">
              </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">DB_PASSWORD</label>
              <div class="col-sm-6">
                <input name="DB_PASSWORD" type="password" value="{{env('DB_PASSWORD_SECOND')}}" class="form-control">
              </div>
            </div>
