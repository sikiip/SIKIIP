...
<!--     css -->
    <link rel="stylesheet" href="/assets/css/datakaryawan.css" type="text/css"/>
     <link rel="stylesheet" href="/assets/css/form-izin.css" type="text/css"/>
...
<div class="be-wrapper be-fixed-sidebar">
    <div class="be-content be-icons-list">
       <h3 class="page-header"><i class="fab fa-wpforms"></i><span>Form Izin</span></h3>
         ...
         <div class="col-lg-12">
          ...
          <form action="/action_page.php">
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="tgl-mulai " name="tgl-mulai" placeholder="Tanggal Mulai">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-75">
                <input type="text" id="tgl-akhir" name="tgl-akhir" placeholder="Tanggal Akhir">
              </div>
            </div>

            <div class="row">
              <div class="col-25">
               <label for="tipeizin">Tipe Izin</label>
              </div>
             <div class="col-75">
                <select type="text" id="tipeizin" name="tipeizin">
            ...
            <div class="row">
             ...
             <div class="col-75">
              <textarea type="text" id="alasan" name="alasan" class="form-control" placeholder="tulis sesuatu..." style="height:200px"></textarea> 
             </div>   
            </div>
          ...
          <div class="row">
           <div class="col-75">  
            <div class="modal-footer">
              ...
              <button type="button" data-dismiss="modal" class="btn btn-primary">Ajukan</button>
            </div>
           </div>
          </div>   
        </form>
