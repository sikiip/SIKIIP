    ...
    <div class="be-content">
      <div class="page-head">
        ...
        <ol class="breadcrumb page-head-nav">
          ...
          <li class="active">Edit Riwayat Pekerjaan</li>
        </ol>
      </div>
      ...
      <div class="main-content container-fluid">
        <div class="row">
          <div class="col-sm-12">
              ...
              <div class="panel-body">
                ...
                <div>
                  <ul class="progressbar">
                    ...
                    <a class="a" href="/profil/{{$data_karyawan->nik}}/edit/data_keluarga"><li class="done">Data Keluarga</li></a>
                    <a class="a" href="/profil/{{$data_karyawan->nik}}/edit/data_pendidikan"><li class="done">Riwayat Pendidikan</li></a>
                    <a class="a" href="/profil/{{$data_karyawan->nik}}/edit/data_riwayat_pekerjaan"><li class="active">Riwayat Pekerjaan</li></a><br>
                  </ul><br>
                </div><br>
                  ...
                  <div class="table-responsive noSwipe">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{$data->tanggal_keluar_kerja}}</td>                        
                         ...
                         <div id="edit-data-familia-{{$data->id_riwayat_pekerjaan}}" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="form-group">
                                <label>Tanggal Masuk Kerja (Di Kantor Sebelumnya)</label>
                                <input name="tanggal_masuk_kerja" value="{{$data->tanggal_masuk_kerja}}" type="date" class="form-control">
                              </div>
                              <div class="form-group">
                                <label>Tanggal Selesai Kerja (Di Kantor Sebelumnya)</label>
                                <input name="tanggal_selesai_kerja" value="{{$data->tanggal_selesai_kerja}}" type="date" class="form-control">
                              </div>
                              <div class="form-group">
                                <label>Gaji Akhir</label>
                                <input name="gaji_akhir" value="{{$data->gaji_akhir}}" type="text" class="form-control" >
                              </div>
                              <div class="form-group">
                              ...
                              <div align="center" class="form-group">
                                <img id="foto_verklarin{{$data->id_riwayat_pekerjaan}}" src="/image/Verklarin/{{$data->foto_verklarin}}" alt="Placeholder" class="img-data"><br>
                                <div align="center" class="upload-btn-wrapper">
                                  <button class="btn btn-default">Upload Verklarin</button>
                                  <input id="input_foto_verklarin{{$data->id_riwayat_pekerjaan}}" class="input_foto_verklarin{{$data->id_riwayat_pekerjaan}}" type="file" name="foto_verklarin" onchange="readURL_verklarin_{{$data->id_riwayat_pekerjaan}}(this)"/>
                                </div>
                              </div>
                            </div>
                            ...
                            <script type="text/javascript">
                              ...
                              function readURL_verklarin_{{$data->id_riwayat_pekerjaan}}(input) {
                                if (input.files && input.files[0]) {
                                  var reader = new FileReader();

                                  reader.onload = function (e) {
                                    $('#foto_verklarin{{$data->id_riwayat_pekerjaan}}')
            ...
            <div class="modal-footer">
              <a href="/profil/{{$data_karyawan->nik}}/edit/data_pendidikan"><button type="button" data-dismiss="modal" class="btn btn-default">Kembali</button></a>
              ...
              <a href="/profil/{{Auth::user()->id}}"><button type="button" data-dismiss="modal" class="btn btn-default">Selesai</button></a>
            </div>

            <!-- Modals untuk Edit Tambah Data Familia -->
            <form id="form_submit2" name="form_submit2" action="/profil/tambah/update/data_riwayat_pekerjaan" method="POST" enctype="multipart/form-data">
             @csrf
             <div id="tambah-data-familia" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close"><span class="mdi mdi-close"></span></button>
                    <h3 class="modal-title">Tambah Data Riwayat Pekerjaan</h3>
                  </div>
                  <div class="modal-body">
                   <div class="form-group">
                    <label>Nama Perusahaan</label>
                  ...
                  <div class="form-group">
                    ...
                    <input name="tanggal_masuk_kerja" type="date" class="form-control" required="" >
                  </div>
                  <div class="form-group">
                    <label>Tanggal Keluar Kerja</label>
                    <input name="tanggal_keluar_kerja" type="date" class="form-control" required="" >
                  </div>
                  <div class="form-group">
                    <label>Gaji Akhir</label>
                    <input name="gaji_kerja" type="text" class="form-control" required="">
                  </div>
                  <div class="form-group">
                    <label>Alasan Berhenti</label>
