              ...
              <div class="panel-body">
                ...
                <div>
                  <ul class="progressbar">
                    ...
                    <a class="a" href="/profil/{{$data_karyawan->nik}}/edit/data_pendidikan"><li class="active">Riwayat Pendidikan</li></a>
                       ...
                       <div id="edit-data-familia-{{$data->id_riwayat_pendidikan}}" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-primary">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <form id="form_submit_edit" name="submit1" action="/profil/{{$data->id_riwayat_pendidikan}}/update/data_pendidikan" method="POST" enctype="multipart/form-data">
                             @csrf
                             <div class="modal-body">
                              ...
                              <div class="modal-body">
                                <div class="text-center">
                                  ...
                                  <div class="xs-mt-50">
                                    ...
                                    <a href="/profil/{{$data->id_riwayat_pendidikan}}/delete/data_pendidikan"><button type="button" class="btn btn-space btn-danger">Hapus</button></a>
                                  </div>
                                </div>
                              </div>
                ...
                <div class="modal-footer">
                  <a href="/profil/{{$data_karyawan->nik}}/edit/data_keluarga"><button type="button" data-dismiss="modal" class="btn btn-default">Kembali</button></a>
                  ...
                  <a href="/profil/{{$data_karyawan->nik}}/edit/data_riwayat_pekerjaan"><button type="button" data-dismiss="modal" class="btn btn-default">Lanjut</button></a>
                </div>

                <!-- Modals untuk Edit Tambah Data Pendidikan -->
                <form id="form_submit2" name="form_submit2" action="/profil/tambah/update/data_pendidikan" method="POST" enctype="multipart/form-data">
                 @csrf
