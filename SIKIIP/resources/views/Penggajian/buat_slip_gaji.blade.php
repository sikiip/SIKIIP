...
$bulan = $arrayBln[(int)$bulan];

$tanggal = $tgl.' '.$bulan.' '.$data_gaji_blade['tahun'];
...
<div style="width: 703px;background-color: white;" class="user-info-list panel panel-default">
  <div class="panel-heading-divider" align="center">
    ...
    <h4>
      <b>
        SLIP GAJI {{$data_gaji_blade['bln']}} {{$data_gaji_blade['tahun']}}
      </b>
    </h4>
  </div>
  <!--  Header Table Start -->
  ...
  <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
    <tbody>
      ...
      <tr>
        <td >Bruto</td>
        <td>Rp{{number_format($data_gaji_blade['bruto'],2,",",".")}}</td>  
      </tr>
      <!--  Row Tunjangan Kinerja End -->
    </tbody>
  </table>
  ...
  <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
    <tbody>
      ...
      <tr>
        <td >Lain-lain</td>
        <td>Rp{{number_format($data_gaji_blade['lain_lain'],2,",",".")}}</td>            
      </tr>
      <!--  Row Tunjangan Jabatan End -->
      <!--  Row Tunjangan Kinerja Start -->
      <tr>
  ...
  <table id="table2" style="table-layout: fixed; word-wrap: break-word; word-break: break-all;" class="table table-bordered table-striped table-hover table-fw-widget">
    <tbody>
     <!--  Row Pengalaman Bulan Start -->
     <tr>
      <td>Netto (Bruto - Total Potongan)</td>
      <td>Rp{{number_format($data_gaji_blade['netto'],2,",",".")}}</td>
    </tr>
    <!--  Row Pengalaman Bulan End -->
  </tbody>
</table>
